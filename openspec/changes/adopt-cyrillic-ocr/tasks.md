...
- [x] 1.1 Install Hailo Dataflow Compiler 5.3.x and verify the compiler targets `hailo10h`.
- [x] 1.2 Download `cyrillic_PP-OCRv5_mobile_rec` and its matching dictionary; verify the reference model recognizes Russian samples.
- [x] 1.3 Export the Cyrillic model to ONNX and verify input, output, and CTC dimensions against the Paddle reference.
...
- [x] 3.2 Update OCR configuration and asset validation; verify the existing Hailo detector remains unchanged.
